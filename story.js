...
squiffy.story.sections = {
	...
	'Go In The Lab': {
		...
		'passages': {
			'passage link': {
				'text': "<p>This is the text for the first passage link.</p></div>",
			},
			'other passage link': {
